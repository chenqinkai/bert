...
def main(_):
    ...
    estimator = tf.contrib.tpu.TPUEstimator(
        ...
        train_batch_size=256)  # error otherwise
    ...
    with tf.gfile.Open(FLAGS.output_file, "w") as f:
        ...
        print("We finished saving matrix")
...
#   --input_file=D:/data/reuters_headlines_by_ticker/horizon_3/embeddings/test.txt \
#   --output_file=D:/data/reuters_headlines_by_ticker/horizon_3/embeddings/test.npy \
#   --vocab_file=D:/data/nlp/bert/uncased_L-12_H-768_A-12/vocab.txt \
#   --bert_config_file=D:/data/nlp/bert/uncased_L-12_H-768_A-12/bert_config.json \
#   --init_checkpoint=D:/data/nlp/bert/uncased_L-12_H-768_A-12/bert_model.ckpt \
#   --layers=-1 \
#   --max_seq_length=64 \
#   --batch_size=8
